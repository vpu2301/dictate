...
CASES_UK: list[tuple[str, str]] = [
    # ── BP patterns ─────────────────────────────────────────────
    ("тиск сто двадцять на вісімдесят",
     "тиск 120/80"),
    ("тиск сто двадцять на вісімдесят міліметрів ртутного стовпчика",
     "тиск 120/80 мм рт. ст."),
    ...
    ("температура від тридцяти шести до тридцяти восьми",
     "температура 36–38"),
    # ── Time ────────────────────────────────────────────────────
