...
def _input(**overrides):
    base = dict(
        ...
        sections=[
            {"section_key": "chief_complaint", "text": "біль у грудях",
...
def test_jcs_sorted_keys():
    ...
    assert obj_str.index('"canonical_version"') < obj_str.index('"lifecycle"') < obj_str.index('"report"') < obj_str.index('"tenant"')
